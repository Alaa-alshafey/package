...
@section('content')
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            عرض كل الأقسام  الفرعية والتحكم بهم وبكل العمليات الخاصة بهم مع امكانية البحث وتصدير تقارير وملفات وطباعتهم
        </div>
            ...
            @foreach($categories as $key=>$item)
                <tr>
                    ...
                    @else
                        <td>null</td>
                    @endif
                    {!!Form::open( ['route' => ['admin.subcategories.destroy',$item->id] ,'id'=>'delete-form'.$item->id, 'method' => 'Delete']) !!}
                    {!!Form::close() !!}
                    <td>
                        <a href="{{route('admin.subcategories.edit',$item->id)}}" data-toggle="tooltip" data-original-title="تعديل"> <i class="icon-pencil7 text-inverse" style="margin-left: 10px"></i> </a>
