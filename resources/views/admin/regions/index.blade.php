...
@section('content')
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">كل الأحياء</h5>
        ...
        <table class="table datatable-button-init-basic">
            ...
            @foreach($regions as $key=>$region)
                <tr>
                    ...
                    {!!Form::open( ['route' => ['admin.regions.destroy',$region->id] ,'id'=>'delete-form'.$region->id, 'method' => 'Delete']) !!}
                    {!!Form::close() !!}
                    <td>
                        <a href="{{route('admin.regions.edit',$region->id)}}" data-toggle="tooltip" data-original-title="تعديل"> <i class="icon-pencil7 text-inverse" style="margin-left: 10px"></i> </a>
                        <a href="#" onclick="Delete({{$region->id}})" data-toggle="tooltip" data-original-title="حذف"> <i class="icon-trash text-inverse text-danger" style="margin-left: 10px"></i> </a>
                    </td>
                </tr>
            @endforeach
            </tbody>
