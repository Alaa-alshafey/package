            ...
            <div class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8">
                ...
                <div class="profile-bar">
                    ...
                    @endif
                        ...
                        {!!Form::open( ['route' => 'mobile_activation' ,'class'=>'form ', 'method' => 'Post','files' => false]) !!}
...
" type="text" class="form-control"
                            ...
                            <div class="form-group">
                                <button style="border-radius: 20px" type="submit" class="nexr-btn">تفعيل</button>
                                <a style="border-radius: 20px; float: left" href="{{route('resend.active')}}" class="nexr-btn"> إعادة إرسال الرمز </a>
                            </div>
                        </div>
                        {!!Form::close() !!}
