...
@section('content')
    ...
    color: white;">
                                        ...
                                        <i class="fa fa-cc-visa"></i> <i
                                                class="fa fa-cc-mastercard"></i>  تفضل بالدخول لاستكمال عمليه الدفع  الالكتروني وتحويل عمولة الموقع
                                    </button>
                        ...
                        <span class="" style="display: block; border-bottom: 2px solid #fff; margin-bottom: 20px"></span>


                        <div class="row">
                            <h3 class="right_text"> 2 - التحويل البنكي</h3>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6 col-md-offset-3">
                                ...
                                <div class="item" id="account_">
                                    ...
                                    <br>
                                    <p><small>رقم الحساب : </small> <span  style="letter-spacing: 8px">24949447000107</span></p>
                                    <p><small>اّيبان : </small> <span class="second" style="letter-spacing: 2px">SA8710000024949447000107</span></p>
