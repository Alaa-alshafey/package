        ...
        <div class="row profile-bg mar-bot">
            ...
            <div class="col-xs-12 col-sm-8 col-md-9">
                <div class="profile-bar">
                    <div class="box">
                        <h2 class="text-right"><span style="font-size: 26px !important;">دفع عمولة الموقع </span></h2>
                        <!--Paypal integration -->
                        <!--
                        <div class="row">

                            <div class="col-xs-12">
                                <button style="text-align: center; background-color: #dddddd" class="btn btn-block btn-info text-center">مبلغ عمولة موقع باكيج : {{ auth()->user()->commission }} ريال</button>
                            </div>
