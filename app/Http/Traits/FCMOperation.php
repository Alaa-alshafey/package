...
trait FCMOperation
{
    public function notifyByFirebase($title, $body, $tokens, $data = [] , $is_notification = true)
    {
        ...
        $headers = array(
            'Authorization: key=AAAA-6tfXd8:APA91bGltLQx7dBC3dsnBTzCfO1hxdGwxKunNYqBoFSlnP6YXe-OWYekG_Ik-8CaWbDoUzDQEGRtL1QRtn1OADLsxSgrjcczmjTdgLmhIIFjC_lw_LvH_OLZVkzr0BWyR9VasNu8amIv',
    ...
    public function Send($token,$title,$content = null,$myData = [])
    {
